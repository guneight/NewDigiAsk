...
extension DeskripsiProdukViewController{
    func setupUIDeskripsiProduk(){
        ...
        UIHelper.setTextLabel(label: produkDetailHeaderLabel, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0.3333333333, green: 0.3333333333, blue: 0.3333333333, alpha: 1), weight: .medium, fontSize: 12, text: "Asuransi Kecelakaan Diri", kerning: 0.2)
        ...
        namaProdukLabel.font = UIFont(name: fontNameHelper.NunitoRegular, size: 17)
        ...
        UIHelper.setTextLabel(label: deskripsiProdukLabel, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0.3529411765, green: 0.3529411765, blue: 0.3529411765, alpha: 0.66), weight: .medium, fontSize: 14, text: text, kerning: 0.04)
        ...
        UIHelper.setTextLabel(label: penggunaLabel, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0.3333333333, green: 0.3333333333, blue: 0.3333333333, alpha: 1), weight: .medium, fontSize: 12, text: "Pengguna (tertanggung)", kerning: 0.12)
        ...
        UIHelper.setTextLabel(label: gantiRugiLabel, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1), weight: .bold, fontSize: 12, text: "Ganti Rugi", kerning: 0.12)
