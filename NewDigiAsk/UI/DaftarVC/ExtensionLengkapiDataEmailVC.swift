...
extension LengkapiDataEmailViewController{
    ...
    func setupUI(){
        ...
        UIHelper.setTextLabel(label: masukDenganEmailLabel, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.4235294118, green: 0.4235294118, blue: 0.4235294118, alpha: 1), weight: .bold, fontSize: 12, text: "Masuk dengan email", kerning: 1)
        ...
        UIHelper.setTextField(textField: emailTextField, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.1333333333, green: 0.1333333333, blue: 0.1333333333, alpha: 1), weight: .regular , fontSize: 16, text: "", kerning: 0.8)
        ...
        UIHelper.setTextLabel(label: aktivasiLabel, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.4235294118, green: 0.4235294118, blue: 0.4235294118, alpha: 1), weight: .light, fontSize: 12, text: "Kami akan mengirimkan link aktivasi melalui email", kerning: 1)
        ...
        UIHelper.setTextLabel(label: namaLengkapLabel, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.4235294118, green: 0.4235294118, blue: 0.4235294118, alpha: 1), weight: .regular, fontSize: 10, text: "Nama langkap", kerning: 1)
        ...
        UIHelper.setTextField(textField: namaLengkaTextField, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.1333333333, green: 0.1333333333, blue: 0.1333333333, alpha: 1), weight: .regular, fontSize: 16, text: "", kerning: 1)
        ...
        UIHelper.setTextLabel(label: kataSandiLabel, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.4235294118, green: 0.4235294118, blue: 0.4235294118, alpha: 1), weight: .regular, fontSize: 10, text: "Password", kerning: 1)
        ...
        UIHelper.setTextField(textField: kataSandiTextField, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.7058823529, green: 0.7058823529, blue: 0.7058823529, alpha: 1), weight: .regular, fontSize: 16, text: "", kerning: 1)
        ...
        UIHelper.setTextLabel(label: minimalKarakter, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.4235294118, green: 0.4235294118, blue: 0.4235294118, alpha: 1), weight: .regular, fontSize: 10, text: "Minimal 6 karakter", kerning: 1)
        ...
        UIHelper.setTextLabel(label: ulangKataSandi, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.4235294118, green: 0.4235294118, blue: 0.4235294118, alpha: 1), weight: .regular, fontSize: 10, text: "Konfirmasi password", kerning: 1)
        ...
        UIHelper.setTextField(textField: ulangKataSandiTextField, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.7058823529, green: 0.7058823529, blue: 0.7058823529, alpha: 1), weight: .regular, fontSize: 16, text: "", kerning: 1)
        ...
        UIHelper.setTextLabel(label: syaratLabel, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.4235294118, green: 0.4235294118, blue: 0.4235294118, alpha: 1), weight: .regular, fontSize: 10, text: "Dengan mendaftar, saya menyetujui Syarat dan ketentuan serta Kebijakan Privasi", kerning: 0.5)
