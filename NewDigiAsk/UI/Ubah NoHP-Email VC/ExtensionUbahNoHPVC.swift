...
extension UbahNoHPViewController{
    func setupUI(){
        ...
        UIHelper.setTextLabel(label: nomorPonselLamaLabel, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0.3529411765, green: 0.3529411765, blue: 0.3529411765, alpha: 0.5), weight: .regular, fontSize: 12, text: "Nomor Ponsel Lama", kerning: 0.06)
        ...
        UIHelper.setTextField(textField: nomorPonselLamaTextField, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), weight: .regular, fontSize: 14, text: "", kerning: 0.5)
        ...
        UIHelper.setTextLabel(label: alertNomorPonselLama, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0.9607843137, green: 0.5098039216, blue: 0.1254901961, alpha: 1), weight: .regular, fontSize: 10, text: "Nomor yang Anda masukkan salah", kerning: 0.5)
        ...
        UIHelper.setTextLabel(label: nomorPonselBaruLabel, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0.3529411765, green: 0.3529411765, blue: 0.3529411765, alpha: 0.5), weight: .regular, fontSize: 12, text: "Nomor Ponsel Baru", kerning: 0.06)
        ...
        UIHelper.setTextField(textField: nomorPonselBaruTextField, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), weight: .regular, fontSize: 14, text: "", kerning: 0.5)
        ...
        UIHelper.setTextLabel(label: alertNomorPonselBaru, fontName: fontNameHelper.NunitoRegular, fontColor: #colorLiteral(red: 0.9607843137, green: 0.5098039216, blue: 0.1254901961, alpha: 1), weight: .regular, fontSize: 10, text: "Nomor yang Anda masukkan salah", kerning: 0.5)
