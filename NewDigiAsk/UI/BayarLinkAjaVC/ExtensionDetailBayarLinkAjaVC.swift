...
extension DetailBayarLinkAjaViewController{
    func setupUI(){
        ...
        UIHelper.makeLabel(label: totalLabel, corner: 0, allignment: .left, leadingAnchor: totalView.leadingAnchor, trailingAnchor: totalView.trailingAnchor, topAnchor: totalView.topAnchor, leadingConstant: 17, trailingConstant: -(totalView.frame.size.width/4), topConstant: 12, heightAnchor: 16, widthAnchor: 0)
