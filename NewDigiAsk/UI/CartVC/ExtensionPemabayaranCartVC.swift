...
extension PembayaranCartViewController {
    ...
    func setupUI(){
        ...
        virtualAccountView.addSubview(bcaBaseView)
        UIHelper.makeView(view: bcaBaseView, leadingAnchor: virtualAccountView.leadingAnchor, trailingAnchor: virtualAccountView.trailingAnchor, topAnchor: virtualAccountView.topAnchor, leadingConstant: 0, trailingConstant: 0, topConstant: 0, corner: 0, heightAnchor: 120, widthAnchor: 0)
        bcaBaseView.isUserInteractionEnabled = true
        bcaBaseView.addSubview(iconBCAimage)
        UIHelper.makeImageView(imageView: iconBCAimage, leadingAnchor: bcaBaseView.leadingAnchor, topAnchor: bcaBaseView.topAnchor, leadingConstant: 12, topConstant: 20, corner: 0, heightAnchor: 13)
        iconBCAimage.widthAnchor.constraint(equalToConstant: 40).isActive = true
        iconBCAimage.image = UIImage(named: "bca")
        
        bcaBaseView.addSubview(virtualAccountBCALabel)
        UIHelper.makeLabel(label: virtualAccountBCALabel, corner: 0, allignment: .left, leadingAnchor: iconBCAimage.trailingAnchor, trailingAnchor: bcaBaseView.trailingAnchor, topAnchor: bcaBaseView.topAnchor, leadingConstant: 12, trailingConstant: 50, topConstant: 20, heightAnchor: 12, widthAnchor: 0)
        ...
        bcaBaseView.addSubview(rightButtonBCA)
        UIHelper.makeSmallButton(smallButton: rightButtonBCA, leadingAnchor: bcaBaseView.trailingAnchor, topAnchor: bcaBaseView.topAnchor, leadingConstant: -30, topConstant: 17, corner: 0, heightAnchor: 11, widthtAnchor: 6, borderWidth: 0, colorBorder: #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0))
    ...
    func setupNavBarPembayaranCart(){
