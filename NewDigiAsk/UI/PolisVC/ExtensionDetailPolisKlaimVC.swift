//
//  ExtensionDetailPolisKlaimVC.swift
//  NewDigiAsk
//
...
extension DetailPolisKlaimViewController {
    
    func setupNavBarDetailPolisKlaim(){
        ...
        detailPolisView.addSubview(manfaatView)
          UIHelper.makeView(view: manfaatView, leadingAnchor: detailPolisView.leadingAnchor, trailingAnchor: detailPolisView.trailingAnchor, topAnchor: metodeLabel.bottomAnchor, leadingConstant: 20, trailingConstant: -20, topConstant: 15, corner: 10, heightAnchor: 71, widthAnchor: 0)
          ...
          detailPolisView.addSubview(dokumentKlaimView)
          UIHelper.makeView(view: dokumentKlaimView, leadingAnchor: detailPolisView.leadingAnchor, trailingAnchor: detailPolisView.trailingAnchor, topAnchor: manfaatView.bottomAnchor, leadingConstant: 20, trailingConstant: -20, topConstant: 10, corner: 10, heightAnchor: 150, widthAnchor: 0)
