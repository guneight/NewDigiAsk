...
extension CheckOutCartViewController: UITableViewDelegate, UITableViewDataSource{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            let cell = tableView.dequeueReusableCell(withIdentifier: "produkCart", for: indexPath)  as! daftarProdukCartTableViewCell
        ...
        func setupUI(){
            ...
            daftarProdukKeranjangTable.register(daftarProdukCartTableViewCell.self, forCellReuseIdentifier: "produkCart")
        ...
        @objc func deleteAllProduk(){
            ...
            alertDeleteAll.addAction(UIAlertAction(title: "Hapus", style: .destructive, handler: {(action)-> Void in
                ...
                self.checkOutButton.setTitle("HOME", for: .normal)
    ...
    class daftarProdukCartTableViewCell: UITableViewCell  {
