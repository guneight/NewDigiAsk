//
//  InputKodeVerifikasiEmailViewController.swift
//  NewDigiAsk
//
...
class InputKodeVerifikasiEmailViewController: UIViewController {
    ...
    extension UITapGestureRecognizer{
        ...
        func didTapsAttributedTextInLabel(label: UILabel, inRange targetRange: NSRange) -> Bool {
