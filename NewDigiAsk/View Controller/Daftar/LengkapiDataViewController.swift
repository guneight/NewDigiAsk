...
class LengkapiDataViewController: UIViewController {
    ...
    func  setupUI(){
        ...
        UIHelper.setTextLabel(label: lengkapiDataAndaLabel, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1), weight: .medium, fontSize: 15, text: "Lengkapi data Anda", kerning: 0.4)
        ...
        UIHelper.makeLabel(label: namaLengkapLabel, corner: 0, allignment: .left, leadingAnchor: lengkapiDataView.leadingAnchor, trailingAnchor: lengkapiDataView.trailingAnchor, topAnchor: lengkapiDataAndaLabel.bottomAnchor, leadingConstant: 24, trailingConstant: -24, topConstant: 30, heightAnchor: 18, widthAnchor: 0)
          UIHelper.setTextLabel(label: lengkapiDataAndaLabel, fontName: "AvantGarde Bk BT", fontColor: #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1), weight: .medium, fontSize: 15, text: "Nama Lengkap", kerning: 0.4)
        ...
        NamaLengkapTextField.attributedPlaceholder = NSAttributedString(string:"Nama lengkap", attributes:[NSAttributedString.Key.foregroundColor: UIColor.gray ,NSAttributedString.Key.font :UIFont(name: "AvantGarde Bk BT", size: 12)!])
        ...
        underLineNamaLengkap.backgroundColor = #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)
